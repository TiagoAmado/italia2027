...
{d:"23/3", wk:"Terça", city:"roma", cityLabel:"Roma", title:"Chegada em Roma", hotel:null, hotelNote:"Chegando em Roma (sem hotel ainda)", budget:103,
 items:[
  ...
  {t:"~14:00", a:"Check-in — Aenea Inn", dur:"30 min", tr:"A pé / metrô (10 min)", p:"—", status:"a-reservar", ci:true, desc:"Primeira base em Roma, no bairro de Monti — tranquilo e charmoso, dá pra ir andando pro Coliseu. Deixem a mala pronta e troquem de roupa antes de sair de novo."},
  {t:"15:30–16:30", a:"Fontana di Trevi", dur:"1h", tr:"A pé (15 min do hotel)", p:"grátis", cat:"atracao", desc:"Sempre cheia, mas vale passar mesmo assim nesse primeiro dia — joguem a moeda de costas, com a mão direita por cima do ombro esquerdo (é a tradição pra garantir volta a Roma)."},
  {t:"16:45–17:30", a:"Panteão", dur:"45 min", tr:"A pé (8 min)", p:"€10,00", cat:"atracao", desc:"Entrada paga desde 2023, mas dá pra comprar na hora se não estiver muito cheio — assim que entrar, olhem pra cima: o óculo no teto é o maior furo estrutural do mundo antigo."},
  {t:"17:45–18:45", a:"Piazza Navona (tempo livre)", dur:"1h", tr:"A pé (16 min)", p:"grátis", cat:"atracao", desc:"Tempo livre pra passear sem pressa entre as fontes de Bernini — bom lugar pra sentar num café e já sentir a energia de Roma no primeiro dia."},
  {t:"19:30–21:00", a:"Jantar — Tonnarello (Trastevere)", dur:"1h30", tr:"A pé ~35min (grátis) / Táxi ~15min (~€13,00)", p:"€65,00", cat:"comida", desc:"Trattoria clássica, animada e sem luxo — cacio e pepe e carbonara são o forte. Costuma dar fila, então cheguem no horário certo ou um pouco antes."}
...
{d:"26/3", wk:"Sexta", city:"sorrento", cityLabel:"Sorrento", title:"Roma → Pompeia → Sorrento", hotel:"Aenea Inn", hotelNote:"Hospedados no Aenea Inn (Roma)", budget:258,
 items:[
  ...
  {t:"15:00–15:30", a:"Check-in — Grace Suites", dur:"30 min", tr:"—", p:"—", status:"a-reservar", ci:true, desc:"Segunda base da viagem, em pleno centro de Sorrento — hotel bem avaliado, ótimo ponto de partida pros passeios da Costa Amalfitana."},
...
{d:"1/4", wk:"Quinta", city:"bologna", cityLabel:"Bologna", title:"Florença → Bologna", hotel:"Palazzo dal Borgo", hotelNote:"Hospedados no Palazzo dal Borgo (Florença)", budget:215,
 items:[
  {t:"11:00–11:20", a:"Checkout — Palazzo dal Borgo", dur:"20 min", tr:"—", p:"—", status:"a-reservar", ci:true, desc:"Checkout com folga suficiente pra caminhar até a estação e embarcar sem pressa."},
...
{d:"5/4", wk:"Segunda", city:"roma", cityLabel:"Veneza → Roma → Voo", title:"Veneza → Roma → Voo", hotel:null, hotelNote:"Sem hotel — trânsito até o voo", budget:158,
 items:[
  {t:"9:15–9:30", a:"Checkout — Hotel Saturnia & International", dur:"15 min", tr:"A pé / vaporetto até Santa Lucia", p:"—", status:"a-reservar", ci:true, desc:"Malas prontas e saída com uma hora de folga para chegar a Venezia Santa Lucia sem correr."},
