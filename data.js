...
{d:"26/3", wk:"Sexta", city:"sorrento", cityLabel:"Sorrento", title:"Roma → Pompeia → Sorrento", hotel:"Aenea Inn", hotelNote:"Hospedados no Aenea Inn (Roma)", budget:258,
 items:[
  {t:"6:15", a:"Checkout — Aenea Inn", dur:"—", tr:"—", p:"—", ci:true, desc:"Deixem as malas prontas na noite anterior — saída bem cedo pro trem antecipado, então já vale ter café da manhã reservado ou algo rápido pra levar."},
  {t:"6:40–7:50", a:"Roma Termini → Napoli Centrale", dur:"1h10", tr:"Frecciarossa/Italo", p:"€75,00", cat:"transporte", desc:"Trem antecipado de propósito, pra dar mais folga na conexão em Nápoles em vez de arriscar uma baldeação apertada. Comprem a passagem com antecedência — sai mais barata e garante os assentos juntos."},
  {t:"8:20–8:50", a:"Napoli Centrale → Pompei Scavi", dur:"~30 min", tr:"EAV Circumvesuviana", p:"€14,00", flag:"Bilhete comprado com antecedência pelo app", cat:"transporte", desc:"Trem regional da EAV Circumvesuviana, sem luxo mas rápido. Comprando o bilhete pelo app antes, a gente evita a fila da bilheteria e ganha ~30min de folga na conexão — sem aquele aperto de trocar de trem em cima da hora. Fiquem de olho nos pertences, é uma linha bem cheia."},
  ...
  {t:"15:00–16:00", a:"Check-in — Grace Suites", dur:"—", tr:"—", p:"—", ci:true, desc:"Segunda base da viagem, em pleno centro de Sorrento — hotel bem avaliado, ótimo ponto de partida pros passeios da Costa Amalfitana."},
...
{d:"27/3", wk:"Sábado", city:"sorrento", cityLabel:"Sorrento", title:"Costa Amalfitana", hotel:"Grace Suites", hotelNote:"Hospedados no Grace Suites (Sorrento)", budget:132,
 items:[
  {t:"8:30–9:20", a:"Sorrento → Positano", dur:"Ônibus SITA ~50min", tr:"Ônibus SITA", p:"€5,00", cat:"transporte", desc:"Replanejado só de ônibus — no fim de março os ferries da Costa não são garantidos, então a gente não conta mais com eles pra não arriscar o dia. A estrada é sinuosa (quem enjoa, sente melhor sentado à frente)."},
  ...
  {t:"11:30–12:15", a:"Positano → Amalfi", dur:"Ônibus SITA ~45-50min", tr:"Ônibus SITA", p:"€5,00", cat:"transporte", desc:"Mesmo raciocínio do trecho anterior — só ônibus, sem depender de ferry sazonal."},
  ...
  {t:"14:00–14:25", a:"Amalfi → Ravello", dur:"~25 min", tr:"Ônibus SITA", p:"€1,50", cat:"transporte", desc:"Trecho novo do roteiro — Ravello é considerado o pedaço mais romântico da Costa, vale muito a subida. Bilhete comprado numa tabacaria/bar antes de embarcar (não vende dentro do ônibus)."},
  ...
  {t:"17:00–18:15", a:"Ravello → Sorrento", dur:"~1h15 (via Amalfi)", tr:"Ônibus SITA (baldeação em Amalfi)", p:"~€6,50", cat:"transporte", desc:"Não tem ligação direta — volta com baldeação em Amalfi. Fiquem de olho no horário do primeiro ônibus pra não perder a conexão."},
...
{d:"29/3", wk:"Segunda", city:"firenze", cityLabel:"Florença", title:"Sorrento → Florença", hotel:"Grace Suites", hotelNote:"Hospedados no Grace Suites (Sorrento)", budget:171,
 items:[
  ...
  {t:"15:00–16:00", a:"Check-in — Palazzo dal Borgo", dur:"—", tr:"—", p:"—", ci:true, desc:"Terceira base, já em Florença — hotel num palazzo histórico perto da estação, ótima localização pra andar a pé por tudo."},
...
{d:"31/3", wk:"Quarta", city:"firenze", cityLabel:"Florença", title:"Florença (Uffizi)", hotel:"Palazzo dal Borgo", hotelNote:"Hospedados no Palazzo dal Borgo (Florença)", budget:142,
 items:[
  {t:"8:15–8:30", a:"Chegada Galleria degli Uffizi", dur:"—", tr:"A pé (18 min do hotel)", p:"€19,00", flag:"Reserva obrigatória — chegar 15 min antes", cat:"atracao", desc:"Cheguem uns 15 minutos antes do horário reservado — mesmo com ingresso marcado, tem uma fila de retirada que pode demorar. Esse horário (8:15–8:30) é justamente o do desconto oficial da manhã: €19 em vez dos €25-29 do resto do dia."},
  ...
  {t:"14:30–16:30", a:"Giardino di Boboli", dur:"2h", tr:"A pé (10 min)", p:"€13,00", cat:"atracao", desc:"Jardins renascentistas enormes atrás do Palazzo Pitti — bom pra caminhar com calma, tem sombra e vista de Florença lá de cima. Ingresso avulso antecipado."},
...
{d:"1/4", wk:"Quinta", city:"bologna", cityLabel:"Bologna", title:"Florença → Bologna", hotel:"Palazzo dal Borgo", hotelNote:"Hospedados no Palazzo dal Borgo (Florença)", budget:145,
 items:[
  {t:"11:30–12:30", a:"Checkout — Palazzo dal Borgo", dur:"—", tr:"—", p:"—", ci:true, desc:"Checkout mais tarde — dá pra aproveitar a manhã com calma antes de pegar o trem."},
...
{d:"2/4", wk:"Sexta", city:"ferrari", cityLabel:"Ferrari Day", title:"Ferrari Day", hotel:"Luxury Station Suite", hotelNote:"Hospedados no Luxury Station Suite (Bologna)", budget:505,
 items:[
  ...
  {t:"18:35–19:00", a:"Modena → Bologna Centrale", dur:"~20–25 min", tr:"Trenitalia Regionale", p:"€12,00", cat:"transporte", desc:"Último trecho regional do dia — sem pressa nenhuma, ainda dormimos aqui em Bologna, então dá pra ir com calma direto pra aula de massa."},
  {t:"20:00–21:30", a:"Aula de massa fresca em Bologna", dur:"1h30", tr:"A pé/táxi (depende da escola escolhida)", p:"~€70,00/pessoa", flag:"Fornecedor a escolher", cat:"comida", desc:"Substitui o jantar de hoje — aula prática de tortellini/tagliatelle já com a refeição inclusa, uma experiência mais única do que só sentar num restaurante na capital italiana da massa artesanal. Ainda falta escolher a escola: pesquisei uma faixa de €65-85/pessoa entre as opções com aula + refeição + vinho, mas não reservei nenhuma específica."}
 ], end:"Dormindo no Luxury Station Suite (Bologna)"},
...
{d:"3/4", wk:"Sábado", city:"venezia", cityLabel:"Veneza", title:"Bologna → Veneza", hotel:"Luxury Station Suite", hotelNote:"Hospedados no Luxury Station Suite (Bologna)", budget:175,
 items:[
  {t:"10:00–10:30", a:"Checkout — Luxury Station Suite", dur:"—", tr:"—", p:"—", ci:true, desc:"Agora sim, a segunda noite em Bologna acabou — checkout com calma, sem pressa de manhã."},
  {t:"10:45–12:15", a:"Bologna Centrale → Venezia Santa Lucia", dur:"~1h10–1h30", tr:"Frecciarossa", p:"€80,00", cat:"transporte", desc:"Trem de alta velocidade direto até Veneza — chegando de manhã, sobra a tarde inteira pra já sentir a cidade, sem a correria do plano antigo de viajar de noite."},
  {t:"12:45–13:45", a:"Check-in — Hotel Saturnia & International", dur:"—", tr:"—", p:"—", ci:true, desc:"Última base da viagem, direto no centro histórico de San Marco — hotel de charme, num palazzo antigo."},
  ...
  {t:"14:45–15:45", a:"Basílica de São Marcos", dur:"1h", tr:"A pé (2 min)", p:"€10,00", cat:"atracao", desc:"Interior coberto de mosaicos dourados — a fila pode ser longa, então vale reservar entrada rápida (skip-the-line) se disponível."},
...
{d:"5/4", wk:"Segunda", city:"roma", cityLabel:"Veneza → Roma → Voo", title:"Veneza → Roma → Voo", hotel:null, hotelNote:"Sem hotel — trânsito até o voo", budget:158,
 items:[
  {t:"10:15", a:"Checkout — Hotel Saturnia & International", dur:"—", tr:"—", p:"—", ci:true, desc:"Malas prontas — hoje é só trânsito até o voo, sem mais nenhuma noite de hotel."},
  ...
  {t:"19:00–19:32", a:"Roma Termini → Fiumicino", dur:"Leonardo Express ~32min", tr:"Leonardo Express", p:"€28,00", cat:"transporte", desc:"Mesmo trajeto da chegada, agora de volta — o Leonardo Express é a opção mais previsível pra não arriscar perder o voo depois de pegar a bagagem no locker."},
