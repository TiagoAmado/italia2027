...
const HOTEL_PRICES_CHECKED_AT = '2026-08-22';
...
// URL e preço podem mudar sem quebrar contagem de noites ou links derivados.
const HOTEL_CATALOG = {
  aenea: {name:'Aenea Inn', city:'Roma', address:'Via Urbana, 156, 00184 Roma RM, Italy', bookingUrl:'https://www.booking.com/hotel/it/aenea-superior-inn.html', priceEUR:171.00},
  grace: {name:'Grace Suites', city:'Sorrento', address:'Via Luigi de Maio, 14, 80067 Sorrento NA, Italy', bookingUrl:'https://www.booking.com/hotel/it/grace-suites.html', priceEUR:160.00},
  palazzo: {name:'Palazzo dal Borgo', city:'Florença', address:'Via della Scala, 6, 50123 Firenze FI, Italy', bookingUrl:'https://www.booking.com/hotel/it/aprile-palazzo-dal-borgo.html', priceEUR:155.60},
  luxury: {name:'Luxury Station Suite', city:'Bologna', address:'Via Giovanni Amendola, 15, 40121 Bologna BO, Italy', bookingUrl:'https://www.booking.com/hotel/it/luxury-station-suite-1.html', priceEUR:126.90},
  saturnia: {name:'Hotel Saturnia & International', city:'Veneza', address:'Calle Larga XXII Marzo, 2398, 30124 Venezia VE, Italy', bookingUrl:'https://www.booking.com/hotel/it/hotelsaturniainternational.html', priceEUR:275.40}
};
...
const HOTEL_PRICES_EUR = Object.fromEntries(Object.values(HOTEL_CATALOG).map(hotel=>[hotel.name, hotel.priceEUR]));
...
{d:"23/3", wk:"Terça", city:"roma", cityLabel:"Roma", title:"Chegada em Roma", hotel:null, hotelNote:"Chegando em Roma (sem hotel ainda)", overnightHotelId:"aenea", budget:107,
 items:[
  ...
  {t:"~14:00", a:"Check-in — Aenea Inn", dur:"30 min", tr:"A pé / metrô (10 min)", p:"—", status:"a-reservar", ci:true, hotelId:"aenea", desc:"Primeira base em Roma, no bairro de Monti — tranquilo e charmoso, dá pra ir andando pro Coliseu. Deixem a mala pronta e troquem de roupa antes de sair de novo."},
  {t:"15:00–16:00", a:"Fontana di Trevi", dur:"1h", tr:"A pé (15 min do hotel)", p:"grátis", cat:"atracao", desc:"Sempre cheia, mas vale passar mesmo assim nesse primeiro dia — joguem a moeda de costas, com a mão direita por cima do ombro esquerdo (é a tradição pra garantir volta a Roma)."},
  {t:"16:15–17:00", a:"Panteão", dur:"45 min", tr:"A pé (8 min)", p:"€14,00", cat:"atracao", desc:"Aberto atualmente até 19h, com último ingresso individual às 18h30. O valor considera dois ingressos inteiros de €7; reconfirmar horário e tarifa perto da viagem. Assim que entrar, olhem pra cima: o óculo no teto é o maior furo estrutural do mundo antigo."},
  {t:"17:15–18:00", a:"Piazza Navona (tempo livre)", dur:"45 min", tr:"A pé (16 min)", p:"grátis", cat:"atracao", desc:"Tempo livre pra passear sem pressa entre as fontes de Bernini — bom lugar pra sentar num café e já sentir a energia de Roma no primeiro dia."},
...
{d:"24/3", wk:"Quarta", city:"roma", cityLabel:"Roma", title:"Roma Antiga", hotel:"Aenea Inn", hotelNote:"Hospedados no Aenea Inn (Roma)", overnightHotelId:"aenea", budget:150,
 items:[
...
{d:"25/3", wk:"Quinta", city:"roma", cityLabel:"Roma", title:"Vaticano", hotel:"Aenea Inn", hotelNote:"Hospedados no Aenea Inn (Roma)", overnightHotelId:"aenea", budget:227,
 items:[
...
{d:"26/3", wk:"Sexta", city:"sorrento", cityLabel:"Sorrento", title:"Roma → Pompeia → Sorrento", hotel:"Aenea Inn", hotelNote:"Hospedados no Aenea Inn (Roma)", overnightHotelId:"grace", budget:258,
 items:[
  {t:"6:15", a:"Checkout — Aenea Inn", dur:"—", tr:"—", p:"—", status:"a-reservar", ci:true, hotelId:"aenea", desc:"Deixem as malas prontas na noite anterior — saída bem cedo pro trem antecipado, então já vale ter café da manhã reservado ou algo rápido pra levar."},
  ...
  {t:"15:00–15:30", a:"Check-in — Grace Suites", dur:"30 min", tr:"—", p:"—", status:"a-reservar", ci:true, hotelId:"grace", desc:"Segunda base da viagem, em pleno centro de Sorrento — hotel bem avaliado, ótimo ponto de partida pros passeios da Costa Amalfitana."},
...
{d:"29/3", wk:"Segunda", city:"firenze", cityLabel:"Florença", title:"Sorrento → Florença", hotel:"Grace Suites", hotelNote:"Hospedados no Grace Suites (Sorrento)", overnightHotelId:"palazzo", budget:171,
 items:[
  {t:"8:00", a:"Checkout — Grace Suites", dur:"—", tr:"—", p:"—", status:"a-reservar", ci:true, hotelId:"grace", desc:"Saída cedo de novo — deixem tudo arrumado na noite anterior pra não correr de manhã."},
  ...
  {t:"15:00–16:00", a:"Check-in — Palazzo dal Borgo", dur:"—", tr:"—", p:"—", status:"a-reservar", ci:true, hotelId:"palazzo", desc:"Terceira base, já em Florença — hotel num palazzo histórico perto da estação, ótima localização pra andar a pé por tudo."},
...
{d:"30/3", wk:"Terça", city:"firenze", cityLabel:"Florença", title:"Florença Clássica", hotel:"Palazzo dal Borgo", hotelNote:"Hospedados no Palazzo dal Borgo (Florença)", overnightHotelId:"palazzo", budget:104,
 items:[
...
{d:"31/3", wk:"Quarta", city:"firenze", cityLabel:"Florença", title:"Florença (Uffizi)", hotel:"Palazzo dal Borgo", hotelNote:"Hospedados no Palazzo dal Borgo (Florença)", overnightHotelId:"palazzo", budget:142,
 items:[
...
{d:"1/4", wk:"Quinta", city:"bologna", cityLabel:"Bologna", title:"Florença → Bologna", hotel:"Palazzo dal Borgo", hotelNote:"Hospedados no Palazzo dal Borgo (Florença)", overnightHotelId:"luxury", budget:215,
 items:[
  {t:"11:00–11:20", a:"Checkout — Palazzo dal Borgo", dur:"20 min", tr:"—", p:"—", status:"a-reservar", ci:true, hotelId:"palazzo", desc:"Checkout com folga suficiente pra caminhar até a estação e embarcar sem pressa."},
  ...
  {t:"13:00", a:"Check-in — Luxury Station Suite", dur:"—", tr:"—", p:"—", status:"a-reservar", ci:true, hotelId:"luxury", desc:"Última base antes de Veneza — bem pertinho da Bologna Centrale, ótimo já que amanhã (Ferrari Day) a gente sai cedo justamente daqui da estação."},
...
{d:"2/4", wk:"Sexta", city:"ferrari", cityLabel:"Ferrari Day", title:"Ferrari Day", hotel:"Luxury Station Suite", hotelNote:"Hospedados no Luxury Station Suite (Bologna)", overnightHotelId:"luxury", budget:505,
 items:[
...
{d:"3/4", wk:"Sábado", city:"venezia", cityLabel:"Veneza", title:"Bologna → Veneza", hotel:"Luxury Station Suite", hotelNote:"Hospedados no Luxury Station Suite (Bologna)", overnightHotelId:"saturnia", budget:175,
 items:[
  {t:"10:00–10:30", a:"Checkout — Luxury Station Suite", dur:"—", tr:"—", p:"—", status:"a-reservar", ci:true, hotelId:"luxury", desc:"Agora sim, a segunda noite em Bologna acabou — checkout com calma, sem pressa de manhã."},
  ...
  {t:"12:45–13:45", a:"Check-in — Hotel Saturnia & International", dur:"—", tr:"—", p:"—", status:"a-reservar", ci:true, hotelId:"saturnia", desc:"Última base da viagem, direto no centro histórico de San Marco — hotel de charme, num palazzo antigo."},
...
{d:"5/4", wk:"Segunda", city:"roma", cityLabel:"Veneza → Roma → Voo", title:"Veneza → Roma → Voo", hotel:null, hotelNote:"Sem hotel — trânsito até o voo", budget:158,
 items:[
  {t:"9:15–9:30", a:"Checkout — Hotel Saturnia & International", dur:"15 min", tr:"A pé / vaporetto até Santa Lucia", p:"—", status:"a-reservar", ci:true, hotelId:"saturnia", desc:"Malas prontas e saída com uma hora de folga para chegar a Venezia Santa Lucia sem correr."},
